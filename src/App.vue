...
<div>
  ...
  <div class="container mx-auto px-4 mt-8">
    ...
    <div class="flex flex-col sm:flex-row justify-around items-start border border-gray-300 rounded p-8">
      <PaletteBuilder 
      ...
      />
      <div class="sm:px-8">
        <p>Choose a picker style, and click on a color to see it in action.</p>
    ...
    <canvas id="canvas" class="rounded block w-full h-32"></canvas>    
...
export default {
  ...
  data() { 
    ...
    <p class="pb-3">Now the "palette" variable holds the output of whatever palette is built. You can watch it and do something when it is update by assigning a watcher:</p>
    <pre>
watch: {
  palette: function() {
  ...
  methods: {
    buildCanvas() {
        ...
        this.palette.forEach((v, i) => {
          ...
          console.log(position, this.palette.length + 1)
